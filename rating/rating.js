    ...
    stars.click(function(){
		if(settings.cancel == true){
			...
			if(settings.curvalue == 1)
			{
				...
				checkurl = 'http://localhost/mock_page/placedOrderAddFavourite.php';
				alert("ifmeghusa");
			}
			else if(settings.curvalue == 0)
			{
				checkurl = 'http://localhost/mock_page/placedOrderRemoveFavourite.php';
				alert("elseifmeghusa");
			}
			alert("checkurl" + checkurl);
			jQuery.extend(container, {
				url: checkurl
			});
			jQuery.post(container.url, {
